...
import { AppBar, Notification, defaultTheme,Sidebar } from 'admin-on-rest/lib/mui';
import { translate } from 'admin-on-rest';


import { MerchantIcon } from './merchants/merchants';
...
const items = [
    { name: 'Merchants',icon: <MerchantIcon/> },
